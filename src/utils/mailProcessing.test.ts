...
describe('extractActionItems', () => {
  it('creates action items for task-like emails and skips informational emails', () => {
    ...
    expect(actionEmailIds).toContain('email_insurance_documents')
    expect(actionEmailIds).toContain('email_library_renewal')
    expect(actionEmailIds).toContain('email_soccer_forms')
